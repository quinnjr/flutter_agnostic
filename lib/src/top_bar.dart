...
/// Provides a wrapper around underlying [AppBar] and [CupertinoNavigationBar] widgets.
class AgnosticTopBar extends StatelessWidget {
  /// The [AppBar] or [CupertinoNavigationBar] returned by the build function.
